# Public compatibility audit — `insertion_sort.py`

This audit covers public callsites, overrides, and changed APIs for `12-insertion-sort`.
...
- **Verified public symbol(s):** `insertion_sort`.
...
Renaming the claim file to [`insertion-sort-spec.k`](insertion-sort-spec.k) is documentation/artifact naming
