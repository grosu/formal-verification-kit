...
| [`fibonacci-spec.k`](fibonacci-spec.k) | the K reachability claims (contract + circularities) |
...
- [`fibonacci-spec.k`](fibonacci-spec.k) — program-specific K claims for `fibonacci`; [`mini-python.k`](mini-python.k) is only the mini-Python semantics.
