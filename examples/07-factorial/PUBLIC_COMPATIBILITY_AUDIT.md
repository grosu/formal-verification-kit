# Public compatibility audit — `factorial.py`

This audit covers public callsites, overrides, and changed APIs for `07-factorial`.
...
- **Verified public symbol(s):** `factorial`.
...
Renaming the claim file to [`factorial-spec.k`](factorial-spec.k) is documentation/artifact naming
