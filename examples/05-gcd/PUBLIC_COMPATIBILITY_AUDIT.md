# Public compatibility audit — `gcd.py`

This audit covers public callsites, overrides, and changed APIs for `05-gcd`.
...
Renaming the claim file to [`gcd-spec.k`](gcd-spec.k) is documentation/artifact naming
