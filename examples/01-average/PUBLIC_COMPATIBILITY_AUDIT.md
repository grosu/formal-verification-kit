# Public compatibility audit — `average.py`

This audit covers public callsites, overrides, and changed APIs for `01-average`.
...
- **Verified public symbol(s):** `average`.
...
Renaming the claim file to [`average-spec.k`](average-spec.k) is documentation/artifact naming
