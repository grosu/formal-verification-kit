# Public compatibility audit — `reverse.py`

This audit covers public callsites, overrides, and changed APIs for `11-reverse`.
...
- **Verified public symbol(s):** `reverse`.
...
Renaming the claim file to [`reverse-spec.k`](reverse-spec.k) is documentation/artifact naming
